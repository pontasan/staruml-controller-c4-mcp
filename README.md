...
4. The HTTP server starts — all C4 Model Diagram tools become available via MCP
...
```bash
claude mcp add staruml-c4 node /absolute/path/to/staruml-controller-c4-mcp/dist/index.js
```
